...
echo.
echo ============================================================
echo              ⚡ RAJA ACTIVATOR v5.0
echo              ====================
echo              Pure HWID Activation
echo              By @priyanshu
echo ============================================================
echo.
...
:: ============================================================
::  ACTIVATE WINDOWS - PURE HWID (MAS CODE COPIED - FIXED)
:: ============================================================
...
:: ============================================================
::  PURE HWID ACTIVATION - NO COMMENTS, CLEAN CODE
:: ============================================================
...
$hwidKeys = @{
    ...
    '119' = 'XKCNC-J26Q9-KFHD2-FKTHY-KD72Y'
    '121' = 'YNMGQ-8RYV3-4PGQ3-C8XTP-7CFBY'
    '122' = '84NGF-MHBT6-FXBX8-QWJK7-DRR8H'
    '125' = 'KCNVH-YKWX8-GJJB9-H9FDT-6F7W2'
    '126' = '2DBW3-N2PJG-MVHW3-G7TDK-9HKR4'
    '138' = 'G3KNM-CHG6T-R36X3-9QDG6-8M8K9'
    '139' = 'HNGCC-Y38KG-QVK8D-WMWRK-X86VK'
    ...
    '178' = 'V3WVW-N2PV2-CGWC3-34QGF-VMJ2C'
    '179' = 'NH9J3-68WK7-6FB93-4K3DF-DJ4F6'
    '188' = 'XQQYW-NFFMW-XJPBH-K8732-CKFFD'
    '191' = 'QPM6N-7J2WJ-P88HH-P3YRH-YY74H'
    '202' = 'K9VKN-3BGWV-Y624W-MCRMQ-BHDCD'
