...
:: ============================================================
::  RAJA ACTIVATOR v3.0 (AUTO EDITION DETECTION)
...
echo ============================================================
echo.
echo   [ 1 ]  Activate !winedition! (HWID Digital License)
...
echo.
echo ============================================================
echo   RAJA ACTIVATOR - ACTIVATION STATUS
echo ============================================================
echo.
echo   Checking !winedition! Activation Status...
echo ============================================================
echo.
...
:: ============================================================
::  ACTIVATE WINDOWS (EXACT EDITION)
:: ============================================================
...
if defined _perm (
    echo   !winedition! is already activated!
    echo.
...
if defined _perm (
    ...
    echo.
    echo ============================================================
    echo   🎉 Congratulations! Your Windows is now activated!
    echo.
    echo   📌 Edition        : !winedition!
    echo   📌 Version        : %winver%
    echo   📌 Type           : !edition_type!
